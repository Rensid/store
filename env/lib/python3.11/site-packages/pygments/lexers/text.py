...
from pygments.lexers.configs import (ApacheConfLexer, IniLexer,
                                     LighttpdConfLexer, NginxConfLexer,
                                     PropertiesLexer, RegeditLexer,
                                     SquidConfLexer, UnixConfigLexer)
...
from pygments.lexers.markup import (BBCodeLexer, GroffLexer, MoinWikiLexer,
                                    RstLexer, TexLexer)
