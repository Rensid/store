...
from pygments.lexers.actionscript import (ActionScript3Lexer,
                                          ActionScriptLexer, MxmlLexer)
from pygments.lexers.css import CssLexer, SassLexer, ScssLexer
from pygments.lexers.data import JsonLexer
from pygments.lexers.html import (DtdLexer, HamlLexer, HtmlLexer, JadeLexer,
                                  ScamlLexer, XmlLexer, XsltLexer)
from pygments.lexers.javascript import (CoffeeScriptLexer, DartLexer,
                                        JavascriptLexer, LassoLexer,
                                        LiveScriptLexer, ObjectiveJLexer,
                                        TypeScriptLexer)
