...
from git.compat import defenc, is_win, safe_decode
...
from git.types import (TBD, Commit_ish, ConfigLevels_Tup, Lit_config_levels,
                       PathLike, Tree_ish, TypedDict, assert_never)
