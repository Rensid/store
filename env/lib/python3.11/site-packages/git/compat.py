...
import os
import sys
from typing import (IO, Any, AnyStr, Dict, Optional, Tuple, Type, Union,
                    overload)

from gitdb.utils.encoding import force_bytes  # @UnusedImport
from gitdb.utils.encoding import force_text  # @UnusedImport
